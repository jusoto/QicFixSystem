<%-- 
    Document   : profileTower
    Created on : Apr 26, 2016, 8:34:48 AM
    Author     : Juan
--%>
...
<%
    ...
    tower = new Tower();
    String state = "";
    if(session.getAttribute("tower")!=null){
        tower = (Tower) session.getAttribute("tower");
        state = tower.getState()!=null?tower.getState():"";
    }
%>
<html>
    <head>
    ...
    <body>
        ...
        <div class="row register-form">
            <div class="col-md-8 col-md-offset-2">
                <form class="form-horizontal custom-form" action="updateTower" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" name="fname" value="<%=tower.getFname()%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" name="lname" value="<%=tower.getLname()%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" alt="MM/DD/YYYY" name="dob" value="<%=tower.getDob()!=null?tower.getDob():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" name="phone" value="<%=tower.getPhone()!=null?tower.getPhone():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" name="street_address" value="<%=tower.getStreetAddress()!=null?tower.getStreetAddress():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" name="city" value="<%=tower.getCity()!=null?tower.getCity():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="text" name="zipcode" value="<%=tower.getZipcode()!=null?tower.getZipcode():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="email" name="email" value="<%=tower.getEmail()!=null?tower.getEmail():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="permit_number" value="<%=tower.getPermitNumber()!=null?tower.getPermitNumber():""%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-6 input-column">
                            <input class="form-control" type="price_mile" value="<%=tower.getPriceMile()!=null?tower.getPriceMile():""%>"/>
                        </div>
                    </div>
